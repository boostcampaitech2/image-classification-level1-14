...
from dataset import MaskBaseDataset , get_fixed_labeled_csv
from dataset import get_cropped_and_fixed_images
...
if __name__ == '__main__':
    ...
    if os.path.isflie("/opt/ml/code/labeled_data.csv"):
